...
def main():
    ...
    st.set_page_config(page_title = 'Analise Telemarketing', \
    ...
    st.write('# Analise Telemarketing')
    st.markdown("---")
    ...
    if (data_file_1 is not None):
        ...
        if graph_type == 'Barras':
            ...
            bank_raw_target_perc.set_index('y').plot(kind='pie', autopct='%.2f', y='percentage', ax=ax[0])
            ax[0].set_title('Dados brutos',
                            fontweight="bold")
            
            bank_target_perc.set_index('y').plot(kind='pie', autopct='%.2f', y='percentage', ax=ax[1])
            ax[1].set_title('Dados filtrados',
                            fontweight="bold")
