...
def main():
    ...
    st.sidebar.markdown('''
                        <div style="text-align:center">
                            <img src="https://keystoneacademic-res.cloudinary.com/image/upload/element/97/97189_thumb.png" alt="ebac-logo" width=50%>
                        </div>
    ...
    st.markdown('''
                ...
                Neste projeto foi utilizada a base [online shoppers purchase intention](https://archive.ics.uci.edu/ml/datasets/Online+Shoppers+Purchasing+Intention+Dataset)
    ...
    with st.echo():
        ...
        df = pd.read_csv('https://raw.githubusercontent.com/diegomartf/Data-Science-EBAC/refs/heads/main/STREAMLIT_V/EX_2/online_shoppers_intention.csv')
